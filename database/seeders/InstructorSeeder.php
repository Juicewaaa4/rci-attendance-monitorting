...
class InstructorSeeder extends Seeder
{
    ...
    {
        $instructorId = 'b49bde58-5298-4568-b2d5-8b2216156d4b';

        if (!Account::where('account_id', $instructorId)->exists()) {
            Account::create([
        ...
        if (!Assignment::where('instructor_id', $instructorId)->where('section_id', '5b0862fe-e1bb-486f-88b9-16bdc885f5f0')->exists()) {
            Assignment::create([
